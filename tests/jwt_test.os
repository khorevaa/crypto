...
Функция ПолучитьСписокТестов(Знач Тестирование) Экспорт
	...
	ИменаТестов.Добавить("ТестДолжен_ПроверитьРаботуКласса_HS256");

	Возврат ИменаТестов;

КонецФункции

Процедура ТестДолжен_ПроверитьРаботуКласса_HS256() Экспорт
	...
	jwt = новый jwt(ХешФункция.SHA256);
	...
	Ожидаем.Что(РасшифрованныеДанные.iat, "Расшифрованные данные iat должны совпадать").Равно(ДанныеКлюча.iat);
